    ...
    const fetchRecommendations = async () => {
      try {
        ...
        const response = await fetch(
          `https://cineniche3-9-dfbefvebc2gthdfd.eastus-01.azurewebsites.net/api/BrowseRecommendations/${userId}`
        );
    ...
    const fetchGenreRecs = async (
      ...
      try {
        ...
        const res = await fetch(
          `https://cineniche3-9-dfbefvebc2gthdfd.eastus-01.azurewebsites.net/api/BrowseRecommendations/genre/${genre}/${userId}`
        );
